<div class="container-fluid tm-mt-60">
    ...
    <div class="row tm-mb-74 tm-row-1640">
        <div class="col-lg-5 col-md-6 col-12 mb-3">
            <img src="./Catalog-Z About page_files/about.jpg" alt="Image" class="img-fluid">
        </div>
        ...
        <div class="col-md-4 col-12">
            <div class="tm-about-3-col">
                ...
                <div class="text-center">
                    <a href="https://templatemo.com/templates/templatemo_556_catalog_z/about.html#" class="btn btn-primary">Read More</a>
                </div>
            </div>
        </div>
        <div class="col-md-4 col-12">
